...
exports.FIRST_CAST_ROD_MESSAGES =
  exports.MISS_CHANCE_MESSAGES =
  exports.MISS_WONDER_GATE_MESSAGES =
  exports.DUPLICATE_CATCH_MESSAGES =
  exports.NEW_CATCH_MESSAGES =
    void 0;
exports.fillCreatureName = fillCreatureName;
exports.pickMessageVariant = pickMessageVariant;
exports.NEW_CATCH_MESSAGES = [
...
function fillCreatureName(template, creatureDisplayName) {
  return template.replaceAll("{creatureName}", creatureDisplayName);
}
function pickMessageVariant(seed, variants) {
