...
export const LESSONS_BY_MODULE: Record<number, LessonItem[]> = {
  ...
  3: [
    ...
    lesson(3, 6, "Supporting Follow-Through", true),
    lesson(3, 7, "Real-Life Scenarios", true),
  ],
  4: [
    lesson(4, 1, "The Hidden Cost of Praise & Pressure", true),
    lesson(4, 2, "The Failure Ritual", true),
    lesson(4, 3, "Identity Collapse & Avoidance Loops", true),
    lesson(4, 4, "Naming Disappointment & Sitting With Discomfort", true),
    lesson(4, 5, "Building Reflection Loops", true),
    lesson(4, 6, "Real-Life Scenarios: Losing, Grades & Rejection", true),
  ],
  5: [
    lesson(5, 1, "How Identity Is Formed: The Mirror & The Script", true),
    lesson(5, 2, "The Language That Shapes Identity", true),
    lesson(5, 3, "Emotional Stability Under Uncertainty", true),
    lesson(5, 4, "Independent Thinking", true),
    lesson(5, 5, "Meaning-Driven Motivation", true),
    lesson(5, 6, "Long-Term Integration", true),
  ],
};
